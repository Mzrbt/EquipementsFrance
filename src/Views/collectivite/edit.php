        ...
        <form method="POST" action="/equipements_sportifs/public/mes-equipements/modifier/<?= $equipement['id'] ?>">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                <div class="form-group">
                    ...
                    <input type="tel" name="telephone" class="form-input" placeholder="Ex: 02 31 30 41 00" value="<?= e($equipement['telephone'] ?? '') ?>">
                </div>
                
                <div class="form-group">
                    <label class="form-label">Email de contact</label>
                    <input type="email" name="email" class="form-input" placeholder="Ex: stade@mairie.fr" value="<?= e($equipement['email'] ?? '') ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="form-checkbox">
                    <input type="checkbox" name="acces_libre" <?= $equipement['acces_libre'] ? 'checked' : '' ?>>
